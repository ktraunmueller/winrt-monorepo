...
public final class CompositionCapabilities : WinRTClass {
    ...
    private static let _ICompositionCapabilitiesStatics: __ABI_Windows_UI_Composition.ICompositionCapabilitiesStatics = try! RoGetActivationFactory("Windows.UI.Composition.CompositionCapabilities")
    ...
    public static func getForCurrentView() throws -> CompositionCapabilities! {
        return try _ICompositionCapabilitiesStatics.GetForCurrentView()
    }
...
open class CompositionDrawingSurface : UWP.CompositionObject, ICompositionSurface {
    ...
    private static var _ICompositionDrawingSurfaceFactory : __ABI_Windows_UI_Composition.ICompositionDrawingSurfaceFactory =  try! RoGetActivationFactory("Windows.UI.Composition.CompositionDrawingSurface")
...
public final class CompositionEffectSourceParameter : WinRTClass, UWP.IGraphicsEffectSource {
    ...
    private static let _ICompositionEffectSourceParameterFactory: __ABI_Windows_UI_Composition.ICompositionEffectSourceParameterFactory = try! RoGetActivationFactory("Windows.UI.Composition.CompositionEffectSourceParameter")
...
open class CompositionTransform : UWP.CompositionObject {
    ...
    private static var _ICompositionTransformFactory : __ABI_Windows_UI_Composition.ICompositionTransformFactory =  try! RoGetActivationFactory("Windows.UI.Composition.CompositionTransform")
...
open class CompositionVirtualDrawingSurface : UWP.CompositionDrawingSurface {
    ...
    private static var _ICompositionVirtualDrawingSurfaceFactory : __ABI_Windows_UI_Composition.ICompositionVirtualDrawingSurfaceFactory =  try! RoGetActivationFactory("Windows.UI.Composition.CompositionVirtualDrawingSurface")

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionvirtualdrawingsurface.trim)
