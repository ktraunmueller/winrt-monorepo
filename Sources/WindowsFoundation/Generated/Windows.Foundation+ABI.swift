        ...
        internal func CreateEmptyImpl() throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateEmpty(pThis, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateUInt8Impl(_ value: UInt8) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateUInt8(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateInt16Impl(_ value: Int16) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateInt16(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateUInt16Impl(_ value: UInt16) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateUInt16(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateInt32Impl(_ value: Int32) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateInt32(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateUInt32Impl(_ value: UInt32) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateUInt32(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateInt64Impl(_ value: Int64) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateInt64(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateUInt64Impl(_ value: UInt64) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateUInt64(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateSingleImpl(_ value: Float) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateSingle(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateDoubleImpl(_ value: Double) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateDouble(pThis, value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateChar16Impl(_ value: Character) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateChar16(pThis, .init(from: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateBooleanImpl(_ value: Bool) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateBoolean(pThis, .init(from: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateStringImpl(_ value: String) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                let _value = try! HString(value)
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateString(pThis, _value.get(), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateInspectableImpl(_ value: Any?) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                let valueWrapper = __ABI_.AnyWrapper(value)
                let _value = try! valueWrapper?.toABI { $0 }
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateInspectable(pThis, _value, &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateGuidImpl(_ value: Foundation.UUID) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateGuid(pThis, .init(from: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateDateTimeImpl(_ value: WindowsFoundation.DateTime) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateDateTime(pThis, .from(swift: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateTimeSpanImpl(_ value: WindowsFoundation.TimeSpan) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateTimeSpan(pThis, .from(swift: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreatePointImpl(_ value: WindowsFoundation.Point) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreatePoint(pThis, .from(swift: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateSizeImpl(_ value: WindowsFoundation.Size) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateSize(pThis, .from(swift: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }

        internal func CreateRectImpl(_ value: WindowsFoundation.Rect) throws -> Any? {
            let (propertyValue) = try ComPtrs.initialize { propertyValueAbi in
                _ = try perform(as: __x_ABI_CWindows_CFoundation_CIPropertyValueStatics.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateRect(pThis, .from(swift: value), &propertyValueAbi))
                }
            }
            return __ABI_.AnyWrapper.unwrapFrom(abi: propertyValue)
        }
