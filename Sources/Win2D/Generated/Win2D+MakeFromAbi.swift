...
fileprivate func makeCanvasDrawEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return CanvasDrawEventArgs(fromAbi: abi)
}

fileprivate func makeCanvasImageSourceFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return CanvasImageSource(fromAbi: abi)
}

fileprivate func makeCanvasRegionsInvalidatedEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return CanvasRegionsInvalidatedEventArgs(fromAbi: abi)
}

fileprivate func makeCanvasSwapChainPanelFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return CanvasSwapChainPanel(fromAbi: abi)
}

fileprivate func makeCanvasVirtualControlFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return CanvasVirtualControl(fromAbi: abi)
}

fileprivate func makeCanvasVirtualImageSourceFrom(abi: WindowsFoundation.IInspectable) -> Any {
...
public class __MakeFromAbi: MakeFromAbi {
    public static func from(typeName: String, abi: WindowsFoundation.IInspectable) -> Any? {
        switch typeName {
            ...
            case "CanvasRegionsInvalidatedEventArgs": return makeCanvasRegionsInvalidatedEventArgsFrom(abi: abi)
            case "CanvasSwapChainPanel": return makeCanvasSwapChainPanelFrom(abi: abi)
            case "CanvasVirtualControl": return makeCanvasVirtualControlFrom(abi: abi)
            case "CanvasVirtualImageSource": return makeCanvasVirtualImageSourceFrom(abi: abi)
            default: return nil
        }
    }
}
